    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
      <div className={CARD_SHAPE + CARD_COLOR}>
        <h2 className="text-lg font-semibold">
          Enter your <span className="text-2xl text-amber-50">name</span> &{" "}
          <span className="text-2xl text-amber-50">gender</span> to join!
        </h2>
        <input
          type="text"
        ...
        <div className="flex gap-2 justify-end">
          <button
            className="p-2 rounded bg-gray-700 hover:bg-red-900 duration-100"
            onClick={onCancel}
          >
            Cancel
          </button>
          <button
            ...
            onClick={onSubmit}
            disabled={isPending || !playerName.trim() || !gender}
          >
